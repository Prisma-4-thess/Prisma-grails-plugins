...
class AutoCompleteRenderer extends AbstractRenderer {
	...
	protected void renderTagContent(Map attrs, Closure body, MarkupBuilder builder) throws RenderException {
		...
		Map internalAttributes = [id: true, controller: true, action: true, name: true, value: true, "class": true, style: true, title: true,org: true, yuiVariableName: true, onItemSelect: true]
		...
		Map htmlAttributes = ["class": "${attrs?.'class'}", style: "${attrs?.style}", 
		                      ...
		                      value: "${attrs?.value}", title: "${attrs?.title}",org: "${attrs?.org}"]
		...
		attributeTransformer.registerTransformer("scriptOrgAppend", AttributeTransformer.stringTransformer)
		attributeTransformer.registerTransformer("scriptOrgParam", AttributeTransformer.stringTransformer)
